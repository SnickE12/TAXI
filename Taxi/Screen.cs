...
namespace Taxi
{
    public static class Screen
    {
        ...
        public static void ShowDistrict(TaxiCenter show)
        {
            Console.WriteLine("LISTA DZIELNIC");
            Console.WriteLine("---------------------------------------------------");
            Console.WriteLine("NUMER | NAZWA | ILOŚĆ TAKSÓWEK");
            foreach (District district in show.Districts)
